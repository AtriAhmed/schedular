...
export default function ScheduleByClassroom() {
  const componentRef = useRef();
    ...
    const setToAddChild = (item) => {
      ...
      db.sessions.where("classroom_id").equals(Number.parseInt(id))
      .toArray()
    )
      useEffect(() => {
        if(sessions){
  ...
  return (
    <div className="container">
       <div className='text-secondary'><Link className='text-decoration-none text-secondary' to="/home"><i className="fas fa-home" /> Home</Link> {'>>'} <Link className='text-decoration-none text-secondary' to="/schedules"> Emplois </Link> {'>>'} <Link className='text-decoration-none text-secondary' to="/schedules/schedules-by-classroom">emploie par salle</Link> {'>>'} {classroom.name ? classroom.name:''} </div>
                <div className="table-responsive">
                    <table className="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"16:00:00"}} item={monday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"15:00:00"}} item={monday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"14:00:00"}} item={monday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"13:00:00"}} item={monday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"12:00:00"}} item={monday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"11:00:00"}} item={monday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"10:00:00"}} item={monday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"09:00:00"}} item={monday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal}  settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Monday",start_time:"08:00:00"}} item={monday.h_8_9}/>
                             <th className="align-middle">الإثنين</th>
                            </tr>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"16:00:00"}} item={tuesday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"15:00:00"}} item={tuesday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"14:00:00"}} item={tuesday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"13:00:00"}} item={tuesday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"12:00:00"}} item={tuesday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"11:00:00"}} item={tuesday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"10:00:00"}} item={tuesday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"09:00:00"}} item={tuesday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Tuesday",start_time:"08:00:00"}} item={tuesday.h_8_9}/>
                                <th className="align-middle">الثلاثاء</th>
                            </tr>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"16:00:00"}} item={wednesday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"15:00:00"}} item={wednesday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"14:00:00"}} item={wednesday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"13:00:00"}} item={wednesday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"12:00:00"}} item={wednesday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"11:00:00"}} item={wednesday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"10:00:00"}} item={wednesday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"09:00:00"}} item={wednesday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Wednesday",start_time:"08:00:00"}} item={wednesday.h_8_9}/>
                                <th className="align-middle">الإربعاء</th>
                            </tr>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"16:00:00"}} item={thursday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"15:00:00"}} item={thursday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"14:00:00"}} item={thursday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"13:00:00"}} item={thursday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"12:00:00"}} item={thursday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"11:00:00"}} item={thursday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"10:00:00"}} item={thursday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"09:00:00"}} item={thursday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Thursday",start_time:"08:00:00"}} item={thursday.h_8_9}/>
                                <th className="align-middle">الخميس</th>
                            </tr>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"16:00:00"}} item={friday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"15:00:00"}} item={friday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"14:00:00"}} item={friday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"13:00:00"}} item={friday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"12:00:00"}} item={friday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"11:00:00"}} item={friday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"10:00:00"}} item={friday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"09:00:00"}} item={friday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Friday",start_time:"08:00:00"}} item={friday.h_8_9}/>
                                <th className="align-middle">الجمعة</th>
                            </tr>
                            <tr>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"16:00:00"}} item={saturday.h_16_17}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"15:00:00"}} item={saturday.h_15_16}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"14:00:00"}} item={saturday.h_14_15}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"13:00:00"}} item={saturday.h_13_14}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"12:00:00"}} item={saturday.h_12_13}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"11:00:00"}} item={saturday.h_11_12}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"10:00:00"}} item={saturday.h_10_11}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"09:00:00"}} item={saturday.h_9_10}/>
                                    <TdClassroom setitems={setItems} settoadd={setToAddChild} settoaddmodal={setToAddModal} settoedit={setToEditChild} settoeditmodal={setToEditModal} data={{classroom_id:id,weekday:"Saturday",start_time:"08:00:00"}} item={saturday.h_8_9}/>
...
<div>
        <div className='text-center mb-4'>{classroom.name ? classroom.name:''}</div>
                <div className="table-responsive">
                    <table className="table table-bordered text-center">
                        <thead>
                            <tr className="bg-light-gray">
